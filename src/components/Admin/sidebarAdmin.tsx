...
const SidebarAdmin = (props: Props) => {
  ...
  return (
    ...
    <div className="flex flex-no-wrap">
      <div style={{minHeight: 716}} className="w-64 absolute sm:relative bg-gray-800 shadow h-screen flex-col justify-between hidden sm:flex">
        <div className="px-8">
          <div className="h-16 w-full flex items-center">
            <NavLink to={'/'}><svg aria-label="Ripples. Logo" role="img" xmlns="http://www.w3.org/2000/svg" width={144} height={30} viewBox="0 0 144 30">
          ...
          <ul className="mt-12">
            <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
              <NavLink to={"/admin/product"} className=" flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                ...
                <span className="text-sm ml-2">List Product</span>
              </NavLink>
            ...
            <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
              <NavLink to={"/admin/category"} className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
            ...
            <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
              <NavLink to={"/admin/user"} className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" />
                  <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1" />
                </svg>
