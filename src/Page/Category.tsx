...
const Category = ({category, RemoveCate}: CategoryProps) => {
  ...
  return (
    <div>
        <button className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"><NavLink to={'/admin/category/add'}>Add Category</NavLink></button>
            ...
            <tbody>
                {category?.map((item,index) => 
                    <tr key={index}>
                        ...
                        onClick= {() => RemoveCate(item._id)}>remove</button></td>
                        <td><button className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
