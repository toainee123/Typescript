        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-2">
                ...
                <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                    Dont have account?{" "}
                    <NavLink to='/signup' tabIndex={0} role="link" aria-label="Sign up here" className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
                        {" "}
                        Sign up here
                    </NavLink >
                </p>
                ...
                <form action="" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mt-6  w-full">
                      <div className="relative flex items-center justify-center">
                          <input aria-label="enter Password" role="input" {...register('password', {required: true})} type="password" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" placeholder='Password' />
